"""
dp_uc37 — PDF renderer for the Alec Bohm second-half turnaround read.
...
Run from this directory so base_url resolves the dp_uc37_fig*.png figures.
"""
...
MD = os.path.join(HERE, "dp_uc37_bohm_turnaround_report.md")
PDF = os.path.join(HERE, "dp_uc37_bohm_turnaround_report.pdf")
...
@page {{
    ...
    @bottom-center {{
        content: "Alec Bohm — Second-Half Turnaround · as of 2026-08-22 · UC #38 / uc-pos-013 / dp_uc37 · page " counter(page) " of " counter(pages);
