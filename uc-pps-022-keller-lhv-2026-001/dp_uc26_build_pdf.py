"""Branded PDF builder for uc-pps-022 (dp_uc26) — markdown -> HTML -> weasyprint.
...
table { border-collapse: collapse; width: 100%; margin: 7pt 0; font-size: 8.2pt; page-break-inside: avoid; }
