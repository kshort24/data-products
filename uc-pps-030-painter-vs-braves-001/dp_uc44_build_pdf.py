...
SRC  = HERE / 'dp_uc44_painter_vs_braves_report.md'
DEST = HERE / 'dp_uc44_painter_vs_braves_report.pdf'
...
@page {{ size: Letter; margin: 14mm 13mm 15mm 13mm;
  @bottom-center {{ content: "uc-pps-030 · dp_uc44 · v1.0.0 · Andrew Painter vs ATL 2026-09-13 · page " counter(page) " of " counter(pages);
