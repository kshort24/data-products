"""
Render dp_uc36_cortes_acquisition_read_report.md -> branded PDF.
...
SRC = HERE / "dp_uc36_cortes_acquisition_read_report.md"
DST = HERE / "dp_uc36_cortes_acquisition_read_report.pdf"
...
@page {{
  ...
  @bottom-center {{
    content: "Nestor Cortes — Acquisition Read · uc-pps-026 / dp_uc36 · page " counter(page) " of " counter(pages);
