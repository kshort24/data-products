"""dp_uc48_build_pdf.py — Markdown -> HTML -> weasyprint, Phillies-branded (house PDF path, inherited from dp_uc47)."""
import base64, re
...
SRC = HERE / 'dp_uc48_bowlan_2026_recap_report.md'
DEST = HERE / 'dp_uc48_bowlan_2026_recap_report.pdf'
...
@page {{ size: Letter; margin: 14mm 13mm 15mm 13mm;
  @bottom-center {{ content: "uc-pps-033 · dp_uc48 · v1.0.0 · Jonathan Bowlan 2026 Recap · data through 2026-09-23 · page " counter(page) " of " counter(pages);
