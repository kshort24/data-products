"""
dp_uc34 — PDF renderer for the Justin Crawford year-to-date read.
...
branded table headers, blockquote warning box. Follows dp_uc28_build_pdf.py.

Run from this directory so base_url resolves the dp_uc34_fig*.png figures.
"""
...
MD = os.path.join(HERE, "dp_uc34_crawford_ytd_report.md")
PDF = os.path.join(HERE, "dp_uc34_crawford_ytd_report.pdf")
...
@page {{
    ...
    @bottom-center {{
        content: "Justin Crawford — Year-to-Date Read · as of 2026-08-13 · UC #35 / uc-pos-011 / dp_uc34 · page " counter(page) " of " counter(pages);
